...
const OrganizationSidebar: React.FC = () => {
  ...
  const mainMenuItems: MenuItem[] = [
    {
      url: "/admin/organizationdashboard",
    ...
    {
      url: "/admin/manageorganizationuser",
  ...
  return (
    <div className="w-200 h-screen p-4 shadow-sm shadow-gray-200 lg:flex flex-col md:flex sm:hidden hidden">
      {/* <div className="mb-6"><img src={logo} alt="" className='w-[100px]' /></div> */}
          ...
          {mainMenuItems.map((menuItem, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="flex">{isActive ? menuItem.activeIcon : menuItem.icon} </span>
