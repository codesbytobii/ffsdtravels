          ...
          <div className="mt-3">
            ...
            <div className="flex items-center justify-between lg:space-x-2 space-x-1 p-3 rounded-xs mt-2">
              ...
              <div className="flex flex-col items-end w-[35%]">
                ...
                {itinerary1.segments[itinerary1.segments.length - 1].arrival_airport}
                </p>
              </div>
            </div>
          </div>
          ...
          <Accordion type="single" collapsible className="w-full">
            ...
            <AccordionItem value="item-1" className="border-none">
              ...
              <AccordionContent className="p-4 flex flex-col gap-4 rounded-sm">
                ...
                <p className="font-bold text-gray-700">Outbound</p>
                ...
                {itinerary2 && (
                  <>
                    <p className="font-bold text-gray-700 mt-4">Inbound</p>
...
interface RoundTripSearchResultProps {
  searchData: Flight[];
}

const RoundTripSearchResult: React.FC<RoundTripSearchResultProps> = ({
  searchData,
}) => {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* {paginatedData.map((flightResult) => (
        ...
        <FlightCard itinerary1={itinerary1} itinerary2={itinerary2} result={flightResult} />
...
export default RoundTripSearchResult;
