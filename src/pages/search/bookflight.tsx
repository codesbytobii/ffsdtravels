...
//       email: passengerForms[0]?.contact.emailAddress,
...
//                           onChange={(e) =>
//                             handlePassengerChange(index, "contact.phones[0].number[0]", e.target.value)
//                           }
//                           required
//                           className="w-full p-2 border border-gray-300 rounded"
//                         />
...
//                       </div>
//                       <div>
//                         <label htmlFor={`phones-${index}`} className="block font-medium">
//                           Phone
//                         </label>
//                         <input
//                           type="tel"
...
//                           onChange={(e) =>
//                             handlePassengerChange(index, "phones.number", e.target.value)
//                           }
//                           required
//                           className="w-full p-2 border border-gray-300 rounded"
//                         />
...
//                           <select
//                             id={`deviceType-${index}`}
//                             value={form.phones[0]?.deviceType || ""}
//                             onChange={(e) =>
//                               handlePassengerChange(index, "phones[0].deviceType", e.target.value)
...
const BookFlightPage: React.FC = () => {
  ...
  const initiatePayment = () => {
    ...
    // var access_code = '2ify3vo1uegbn4w'; // Example access code (ensure it's a string)
