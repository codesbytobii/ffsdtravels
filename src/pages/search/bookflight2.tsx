...
// const BookFlightPage2: React.FC = () => {
...
//           // travelers: {
//           //   id: '1', // Assigns a unique ID starting from "1"
...
// export default BookFlightPage2;
                    ...
                    <div key={index} className="p-4 border rounded mb-4">
                      ...
                      <div>
                        ...
                        >
                          <option value="">Select Holder</option>
                          {nationalities.map((issuanceCountry, i) => (
                          <option key={i} value={issuanceCountry.abbreviation}> {/* Adjust based on JSON structure */}
                            {issuanceCountry.country}
                          </option>
                          ))}
                        </select>
                      ...
                      <div>
                        ...
                        >
                          <option value="">Select Holder</option>
                          {nationalities.map((validityCountry, i) => (
                          <option key={i} value={validityCountry.abbreviation}> {/* Adjust based on JSON structure */}
                            {validityCountry.country}
                          </option>
                          ))}
                        </select>
                      ...
                      <div>
                        ...
                        >
                          <option value="">Select Holder</option>
                          {nationalities.map((nationality, i) => (
                          <option key={i} value={nationality.abbreviation}> {/* Adjust based on JSON structure */}
                            {nationality.country}
                          </option>
                          ))}
                        </select>
